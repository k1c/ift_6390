...
\item{  {\bf Multivariate Regression \french{Régression multivariée}}
\points{}{10}
...
\item{ Derive a closed-form solution for $\W^*$ as a function of the  data matrices $\X\in\R^{n\times d}$ and $\Y\in\R^{n\times p}$.\\
